...
8b. Sentiment tab (on-demand): **X posts from the phone** (Jina reader of live search) + Binance New Listing desk. CoinGecko is not used. Spam/vote-farm posts are labeled, not counted as hype.
