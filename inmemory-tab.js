...
(function () {
  const PROMPT = [
    ...
    '- Holders: SOL only. Jupiter 1h/6h/24h. Mix + wallet depth by threshold (cumulative ≥$1M/100k/10k…) from Rugcheck largest-20, Solscan USD bands. Not Solscan paid analytics. 4h/1w/1M from our snapshots. No fake Solscan growth API.',
