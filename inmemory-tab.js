...
(function () {
  const PROMPT = [
    ...
    '- Cloudflare Durable Object "main" = all Dex/Gecko/candles/alerts. Alarm 60s.',
    ...
    '- Holders: SOL only. Jupiter 1h/6h/24h. Mix + distribution bars = exclusive USD bands on Rugcheck largest-20 only. Do not infer lower thresholds. Not Solscan paid full-holder analytics. 4h/1w/1M from our snapshots. No fake Solscan growth API.',
