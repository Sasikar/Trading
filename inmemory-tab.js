...
(function () {
  const PROMPT = [
    ...
    '- Holders: SOL only. Jupiter 1h/6h/24h. Mix 🐋🦈🐬 from Rugcheck largest-20 using Solscan USD bands (not Solscan paid analytics). 4h/1w/1M from our snapshots. No fake Solscan growth API.',
