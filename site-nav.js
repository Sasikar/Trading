...
const primary=[['Overview','index.html',true],['Pulse','pulse.html',true],['Entry Window','index.html?tab=entrywindow',true],['Hunter','index.html?tab=hunter',true],['Holders','index.html?tab=holders',true],['Anti-FOMO','index.html?tab=antifomo',true],['Position','index.html?tab=position',true],['WOW DIP','index.html?tab=wowdip',true],['OMG','index.html?tab=omg',true],['Markets','watchlist.html',false],['Memes','memes.html',false],['MemeGate','index.html?tab=memegate',true],['Portfolio','portfolio.html',false],['Catalysts','market-catalysts.html',false],['Process','pre-entry-checklist.html',false],['Scanner','scanner.html',false],['Tax','tax-qa.html',false],['Goals','goals.html',false],['Health','health.html',false]];
