(()=>{
  ...
  #overview-memes h2{font-size:20px;margin:0}.om-sub{font-size:10px;color:#8491a1;margin-top:5px}.om-src{font-size:8px;color:#62e3a0;letter-spacing:.08em;white-space:nowrap}.om-link{font-size:9px;color:#62e3a0;font-weight:850;white-space:nowrap}
  ...
  </style><div class="om-head"><div><h2>🔥 Top 10 trending meme coins</h2><div class="om-sub">Momentum watchlist · sorted by current 24h move</div></div><div style="display:flex;align-items:center;gap:12px"><a class="om-link" href="memes.html">MEME DESK →</a><span class="om-src" id="om-source">LOADING</span></div></div><div class="om-grid" id="om-grid"></div>`;
