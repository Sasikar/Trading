...
(function () {
  ...
  function hideOthers() {
    ['showBreakoutMemes', 'showHunter', 'showKeep', 'showHolders', 'showSentiment', 'showFailures', 'showInMemory', 'showVerdict', 'showPositionMonitor', 'showWowDip', 'showOmg', 'showPitfalls'].forEach(
      function (fn) {
        try {
          window[fn](false);
        } catch (e) {}
